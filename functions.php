...
{
    $uploadUrl = '';
    $themeLogoPath = __DIR__ . '/logo.svg';
    $themeLogoUrl = is_readable($themeLogoPath) ? 'data:image/svg+xml;base64,' . base64_encode((string) file_get_contents($themeLogoPath)) : '';
    try {
    ...
    $panel->html(str_replace(array('__LUMINO_UPLOAD_URL__', '__LUMINO_THEME_LOGO_URL__'), array(json_encode($uploadUrl), json_encode($themeLogoUrl)), <<<'HTML'
<style>
...
.lumino-admin-about-hero{display:grid;justify-items:center;margin:0 0 18px;padding:25px 18px 23px;border:1px solid #dbeae1;border-radius:8px;text-align:center;background:linear-gradient(135deg,#f7fcf9,#f0f8f4)}
.lumino-admin-about-logo{width:72px;height:72px;border-radius:18px;box-shadow:0 12px 27px rgba(55,94,76,.14)}
.lumino-admin-about-brand{margin-top:13px;color:#2f5545;font-size:22px;font-weight:700;line-height:1.2}
.lumino-admin-about-brand span{color:#5c967b;font-size:13px;font-weight:600}
.lumino-admin-about-caption{margin:6px 0 0;color:#789084;font-size:12px}
...
(function () {
  function initLuminoControlCenter() {
    ...
    var themeLogoUrl = __LUMINO_THEME_LOGO_URL__;
    ...
    groups.forEach(function (group, index) {
      ...
      if (group.about) {
        fields.innerHTML = '<section class="lumino-admin-about-hero"><img class="lumino-admin-about-logo" src="' + themeLogoUrl + '" alt="Lumino Logo"><strong class="lumino-admin-about-brand">Lumino <span>· 26.0</span></strong><p class="lumino-admin-about-caption">轻语博客主题</p></section><div class="lumino-about-card"><div class="lumino-about-item"><small>作者</small><strong>曦芒</strong><p>Lumino 轻语博客主题的设计与开发。</p></div><div class="lumino-about-item"><small>项目</small><strong>Lumino 轻语博客 26.0</strong><p>现代、克制的 Typecho 写作主题，提供淡薄荷视觉、可视化主题设置与本地图片上传。</p></div><div class="lumino-about-item"><small>GitHub 仓库</small><strong><a href="https://github.com/xiamng0/lumino" target="_blank" rel="noopener">github.com/xiamng0/lumino</a></strong><p>查看主题源码、更新记录与问题反馈。</p></div><div class="lumino-about-item"><small>QQ 用户交流群</small><strong><a href="https://qm.qq.com/q/rflUXn2hPy" target="_blank" rel="noopener">加入 QQ 用户交流群</a></strong><p>反馈问题、交流配置与获取主题更新信息。</p></div><div class="lumino-about-item"><small>作者 QQ</small><strong>3981684967</strong><p>用于主题相关咨询与合作联系。</p></div><div class="lumino-about-item is-wide"><small>作者邮箱</small><strong><a href="mailto:shiyeyunya@vip.qq.com">shiyeyunya@vip.qq.com</a></strong><p>欢迎发送使用反馈与改进建议。</p></div></div>';
      } else {
